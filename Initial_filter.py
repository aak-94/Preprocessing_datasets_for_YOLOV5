...
def main(data_dir,destination): 
    ...
    create_data_representation(train_test_paths[0],seperator,'train dataset',result_dir)
    create_data_representation(train_test_paths[4],seperator,'test dataset',result_dir)
